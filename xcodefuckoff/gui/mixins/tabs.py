...
from xcodefuckoff.gui.widgets import AnimatedButton, AccentButton
from xcodefuckoff.gui.styles import get_advanced_stylesheet


class TabsMixin:
	"""Tab-based UI layout: Dashboard, Process Manager, Settings, Activity Log."""
	...
	def init_ui(self):
		self.setWindowTitle("XcodeFuckOff")
		self.resize(900, 700)
