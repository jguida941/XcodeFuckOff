#!/usr/bin/env python3
"""
Launch XcodeFuckOff from ANY working directory.
...
4) Launches the PyQt6 app via `python -m xcodefuckoff` using the venv's python
"""
...
def main() -> int:
	...
	os.execv(str(py), [str(py), "-m", "xcodefuckoff"])
	return 0
